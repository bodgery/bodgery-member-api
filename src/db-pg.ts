...
let no_rows_callback_builder = (member_id, callback) => {
    return () =>
        callback(new Error('Could not find member for ID ' + member_id));
};
...
export class PG {
    ...
    add_member(
        ...
        this.call_query(query, main_callback, null, error_callback);
    ...
    get_member_photo(
        ...
        let query = {
            ...
            text: ['SELECT', 'photo', 'FROM members WHERE member_id = $1'].join(
                ' ',
            ),
            values: [member_id],
        };
    ...
    put_member_wild_apricot(
        ...
        let query = {
            ...
            values: [wild_apricot_id, member_id],
        };
    ...
    get_member_wild_apricot(
        ...
        let main_callback = rows => success_callback(rows[0]['wildapricot_id']);
    ...
    get_member_rfid(
        ...
        let query = {
            ...
            text: ['SELECT status', 'FROM members', 'WHERE rfid = $1'].join(
                ' ',
            ),
            values: [rfid],
        };
    ...
    rfid_dump(
        ...
        let query = {
            name: 'dump-rfid',
            text: ['SELECT rfid', 'FROM members', 'WHERE status = true'].join(
                ' ',
            ),
            values: [],
        };
    ...
    log_rfid_entry(
        ...
        let query = {
            ...
            values: [rfid, is_active],
        };

        this.call_query(query, success_callback, null, error_callback);
        return true;
    }
    ...
    add_user(
        ...
        let query = {
            ...
            values: [username, password, salt, crypt_type],
        };
    ...
    set_password_data_for_user(
        ...
        let query = {
            ...
            values: [new_password, new_crypt_method, salt, username],
        };
    ...
    private placeholder_generator(): () => string {
    ...
    private insert_address(
        ...
        this.call_query(query, main_callback, null, error_callback, client);
    }
